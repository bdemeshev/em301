...
\title{Домашнее задание 3. Знакомство с RLMS}
...
cat("ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff",fill=TRUE)
@
...
<<"description of vars">>=
var.labels<-attributes(h)$variable.lables
var.labels["pc9.631a"]
@
