...
\item Пусть $u_t$ --- независимые нормальные случайные величины с 
...
\item Найдите безусловная дисперсия GARCH-процессов 
\begin{enumerate}
...
\item Являются ли верными следующие утверждения?
\begin{enumerate}
...
\item Рассмотрим GARCH-процесс $\e_t=\sigma_t \cdot \z_t$, $\sigma^2_t=k+g_1\sigma^2_{t-1}+a_1\e^2_{t-1}$. Найдите
\begin{enumerate}
...
\item Используя 500 наблюдений дневных логарифмических доходностей $y_t$ ,
...
\item Докажите, что в условиях автокорреляции МНК-
