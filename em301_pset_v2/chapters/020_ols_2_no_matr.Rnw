...
\begin{problem}
 Рассмотрим модель с линейным трендом без свободного члена, $y_t=\beta t +\varepsilon_t+\e_t$. 
\begin{enumerate}
...
$$\hat{\beta} = \left( \tilde{X}^T \tilde{X} \right)^{-1} \tilde{X}^T y = \left( [XD]^T [XD] \right)^{-1} [XD]^T y = D^{-1} (X^T X)^{-1} (D^T)^{-1} D^T X^T y = D^{-1} (X^T X)^{-1}X^T y$$
...
$\Var(\tilde{\beta}_2^a) = \Var(\frac{1}{n} \begin{bmatrix}
\frac{1}{x_1} & \frac{1}{x_2} & \ldots & \frac{1}{x_n}
\end{bmatrix} y) = \frac{1}{n^2} \begin{bmatrix}
\frac{1}{x_1} & \frac{1}{x_2} & \ldots & \frac{1}{x_n}
...
\frac{1}{x_1} & \frac{1}{x_2} & \ldots & \frac{1}{x_n}
\end{bmatrix}^T = \frac{1}{n^2} \begin{bmatrix}
\frac{1}{x_1} & \frac{1}{x_2} & \ldots & \frac{1}{x_n}
...
\vdots\\
x_n\\
\end{bmatrix} \right] = \frac{1}{n} \frac{\beta_1 n}{\overline{x}} + \frac{1}{n} \frac{\beta_2 \sum x_i}{\overline{x}} = \frac{\beta_1}{\overline{x}} + \beta_2$
...
\vdots\\
1\\
\end{bmatrix} = \frac{1}{\overline{x}^2} \frac{1}{n^2} \begin{bmatrix}
1 & 1 & \ldots & 1
\end{bmatrix} \Var(\e) \begin{bmatrix}
1\\
1\\
