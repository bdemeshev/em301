---
title: "Эконометрика, em301. Сезон 2017-2018"
...
* Текущие оценки [всех групп](https://docs.google.com/spreadsheets/d/e/2PACX-1vQOnO--pLbo_CTEeP3u0lPh3_jmXASTBwBrNZ8inmpggZsGR5QfSWVXxwNdMg75_Srjp3jKO1dPmZcZ/pubhtml)
...
Помощь [студенту ИП и БП](http://bdemeshev.github.io/em301/Seminar_logs_2017.html) :)


#### Семинар 7. 16 октября 2017

* [Установка R, Rstudio](https://bdemeshev.github.io/installation/r/R_installation.html), [Rmd-файл beda](https://github.com/bdemeshev/em301/raw/master/2017/sem_07/beda.Rmd).
* До 1го ноября пройти курс [Data Manipulations with dplyr](https://www.datacamp.com/courses/dplyr-data-manipulation-r-tutorial)

#### Семинар 1. 4 сентября 2017

## Логи семинаров (базовый поток)

#### Семинар 7. 16 октября 2017

* [Установка R, Rstudio](https://bdemeshev.github.io/installation/r/R_installation.html), [Rmd-файл vorchalka](https://github.com/bdemeshev/em301/raw/master/2017/sem_07/vorchalka.Rmd).
* До 1го ноября пройти курс [Data Manipulations with dplyr](https://www.datacamp.com/courses/dplyr-data-manipulation-r-tutorial)
...
* Конспекты семинаров [2016-2017](http://bdemeshev.github.io/em301/notes_2016/), [2014-2015](https://github.com/bdemeshev/em301/raw/master/2014/ec301_Alex_notes.pdf) с дополнениями (автор: Александр Левкун)
