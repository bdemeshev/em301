...
Разбалловка и немного ответов:
\begin{enumerate}
\item Квадратное уравнение = 1 балл, вывод про стационарность = 1 балл. Система на гаммы = 1 балл, нахождение гамм = 1 балл.
\item Состоятельность = 1 балл, способ получения = 1 балл, асимптотическое смещение = 2 балла
\item переход = 1 балл, проблемы = 1 балл, способ = 2 балла
\item возможность = 2 балла, способ = 2 балла
\item способ оценки логит = 1 балл, недостатки линейной = 1 балл, предельный эффект = 2 балла
\item определение RE = 1 балл, способ оценивания = 3 балла
