...
В множественное регрессии матрица $X$ имеет размер $\Sexpr{n} \times \Sexpr{k}$, $TSS=\Sexpr{TSS}$, $ESS=\Sexpr{ESS}$. Несмещённая оценка для дисперсии случайных ошибок модели примерно равна
