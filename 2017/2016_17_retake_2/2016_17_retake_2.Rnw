...
\pagestyle{fancy}
\lhead{Эконометрика, пересдача-2}
\chead{}
\rhead{30.09.2017, вариант \Sexpr{var_no + sample(c(4, 8, 12, 16), 1)}}
\lfoot{}
\cfoot{}
...
\item Дайтие определение теста множителей Лагранжа. Приведите пример теста множителей Лагранжа для линейных регрессионных моделей: укажите эконометрический смысл проверяемой гипотезы $H_0$, алгоритм расчёта статистики и правило получения вывода. 
